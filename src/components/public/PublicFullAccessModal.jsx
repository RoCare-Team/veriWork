        ...
        <div className="mt-5 space-y-4">
          <div>
            ...
            <input
              ...
              className="mt-1.5 h-11 w-full rounded-xl border border-slate-200 px-3.5 text-sm outline-none focus:border-[#1e3a8a] focus:ring-4 focus:ring-blue-50"
            />
          </div>
          <div>
          ...
          <div>
            ...
            <textarea
              ...
              className="mt-1.5 w-full resize-none rounded-xl border border-slate-200 px-3.5 py-3 text-sm outline-none focus:border-[#1e3a8a] focus:ring-4 focus:ring-blue-50"
            />
