  ...
  return (
    <div className="grid gap-3 sm:grid-cols-3">
      {steps.map((step) => (
        ...
        >
          <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#1a3a8f] text-sm font-bold text-white">
            {step.n}
          </span>
          <div>
        ...
        <div className="mt-4 border-t border-slate-100 pt-4">
          ...
          <div className="mt-2 flex flex-wrap gap-2">
            {skills.map((skill) => (
              <span
                key={skill}
                className="rounded-full bg-blue-50 px-3 py-1 text-xs font-semibold text-[#1a3a8f]"
              >
                {skill}
              </span>
            ))}
  ...
  return (
    <section>
      <div className="mb-4 flex flex-wrap items-end justify-between gap-3">
        ...
        <div className="rounded-xl bg-[#1a3a8f]/10 px-4 py-2 text-center">
          <p className="m-0 text-[10px] font-bold uppercase text-[#1a3a8f]">Verified</p>
          <p className="m-0 text-lg font-extrabold text-[#1a3a8f]">
