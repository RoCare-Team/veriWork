...
const CHART_COLORS = ['#1a3a8f', '#2747b2', '#3b5fc7', '#5b7fd4', '#7a9ee0', '#9ab8eb']
  ...
  return (
    <div className="w-full overflow-x-auto">
      <svg viewBox={`0 0 ${w} ${h}`} className="h-auto min-w-[320px] w-full" aria-hidden="true">
        ...
        <polyline points={linePoints} fill="none" stroke="#1a3a8f" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
        {points.map((p) => (
          <circle key={p.label} cx={p.x} cy={p.y} r="4" fill="#1a3a8f" />
        ))}
      </svg>
        ...
        return (
          <div key={d.range || d.label} className="flex min-w-0 flex-1 flex-col items-center gap-2">
            ...
            <div className="flex w-full flex-1 items-end">
              <div
                className="w-full rounded-t-lg bg-gradient-to-t from-[#1a3a8f] to-[#3b5fc7] transition-all"
