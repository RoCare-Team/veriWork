  ...
  return (
    <article className="rounded-2xl border border-slate-100 bg-white p-5 shadow-sm">
      <div className="flex items-start gap-3">
        <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-blue-100 to-blue-50 text-sm font-bold text-[#1e3a8a]">
          {avatar}
        </div>
      ...
      <div className="mt-5 grid grid-cols-2 gap-3">
        ...
        <button
          type="button"
          onClick={onApprove}
          className="rounded-xl bg-[#1e3a8a] py-2.5 text-sm font-semibold text-white transition hover:bg-[#172554]"
        >
          Approve
        </button>
      </div>
