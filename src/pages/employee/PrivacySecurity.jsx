    ...
    <EmployeeLayout>
      ...
      <section>
        ...
        <div className="mt-5 flex flex-col gap-3">
          <div className="rounded-2xl border border-slate-100 bg-white p-4 md:p-5">
            <div className="flex items-start gap-3">
              ...
              <button
                ...
                className={`relative h-7 w-12 shrink-0 rounded-full transition ${recruiterAccess ? 'bg-[#1e3a8a]' : 'bg-slate-200'}`}
              >
          ...
          <div className="rounded-2xl border border-slate-100 bg-white p-4 md:p-5">
            <div className="flex items-start gap-3">
              <svg className="mt-0.5 h-5 w-5 shrink-0 text-[#1e3a8a]" viewBox="0 0 20 20" fill="none" aria-hidden="true">
              ...
              <button
                ...
                className={`relative h-7 w-12 shrink-0 rounded-full transition ${documentPrivacy ? 'bg-[#1e3a8a]' : 'bg-slate-200'}`}
              >
          ...
          <div className="rounded-2xl border border-slate-100 bg-white p-4 md:p-5">
            <div className="flex items-start gap-3">
              ...
              <button
                ...
                className={`relative h-7 w-12 shrink-0 rounded-full transition ${accessHistory ? 'bg-[#1e3a8a]' : 'bg-slate-200'}`}
              >
        ...
        <div className="mt-5 flex flex-col gap-3">
          <div className="flex items-center justify-between rounded-2xl border border-slate-100 bg-white p-4 md:p-5">
            <div className="flex items-center gap-3">
              <ShieldCheckIcon className="h-5 w-5 text-[#1e3a8a]" />
              <div>
            ...
            <button type="button" className="rounded-xl border border-[#1e3a8a] px-4 py-2 text-sm font-semibold text-[#1e3a8a] hover:bg-blue-50">
              Enable
            </button>
          </div>
      ...
      <Link
        ...
        className="mt-8 inline-block text-sm font-semibold text-[#1e3a8a] no-underline hover:underline"
      >
        ← Back to Settings
      </Link>
    </EmployeeLayout>
