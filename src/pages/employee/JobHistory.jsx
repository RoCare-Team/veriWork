...
function JobHistory() {
  ...
  return (
    <EmployeeLayout>
      <EmployeePageHeader
        ...
        action={
          <Link
            ...
            className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-600 shadow-sm transition hover:border-[#1a3a8f] hover:text-[#1a3a8f]"
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#1a3a8f] via-[#1f3d9a] to-[#2747b2] p-5 text-white shadow-lg md:p-6">
      ...
      {list.length > 0 ? (
        ...
        <div className="mt-6 rounded-2xl border border-dashed border-slate-200 bg-white p-10 text-center">
          ...
          <Link
            to="/employee/job-history/add"
            className="mt-6 inline-flex items-center gap-2 rounded-xl bg-[#1a3a8f] px-5 py-2.5 text-sm font-semibold text-white no-underline hover:bg-[#152b6e]"
          >
      ...
      {list.length > 0 && (
        <div className="mt-8 text-center">
          <Link
            to="/employee/job-history/add"
            className="inline-flex items-center gap-2 rounded-2xl border border-slate-200 bg-white px-6 py-3 text-sm font-semibold text-slate-700 no-underline shadow-sm transition hover:border-[#1a3a8f] hover:text-[#1a3a8f]"
          >
