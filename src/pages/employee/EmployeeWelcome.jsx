...
import { hasVerifiedProfileOnDevice } from '../../store/employeeStore'
      ...
      <div className="flex flex-col gap-8 md:gap-10">
        ...
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
          ...
          <p className="mt-3 max-w-sm text-sm leading-relaxed text-slate-500 md:text-base">
            Like CIBIL for your career — build a verified profile and score that companies use for
