          ...
          <section className="lg:col-span-2">
            <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="flex gap-3">
                <Link to="/employee/invitations" className="text-xs font-semibold text-[#1a3a8f] no-underline hover:underline">
                  All invitations
                </Link>
                <Link to="/employee/access-requests" className="text-xs font-semibold text-[#1a3a8f] no-underline hover:underline">
                  All access requests
                </Link>
              </div>
            </div>
                ...
                return (
                  <article key={`inv-${id}`} className="rounded-2xl border border-slate-100 bg-white p-4 shadow-sm md:p-5">
                    <div className="flex items-start justify-between gap-3">
                      <div>
                        <p className="m-0 text-xs font-bold uppercase tracking-wide text-[#1a3a8f]">Company Invitation</p>
                    ...
                    <div className="mt-4 grid grid-cols-2 gap-3">
                      ...
                      <button
                        ...
                        disabled={actionPending}
                        className="h-11 rounded-xl bg-[#1a3a8f] text-sm font-semibold text-white disabled:opacity-50"
                      >
                        Accept
                      </button>
                    </div>
