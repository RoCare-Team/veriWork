export function printResumePdf() {
  ...
  const styles = `
    * { box-sizing: border-box; }
    ...
    h2 { font-size: 11px; letter-spacing: 0.15em; text-transform: uppercase; color: #1e3a8a; border-bottom: 2px solid #1e3a8a; padding-bottom: 4px; }
    img { object-fit: cover; border-radius: 12px; }
    .score-box { background: linear-gradient(135deg, #1e3a8a, #2748a6); color: white; border-radius: 12px; padding: 12px 16px; text-align: center; }
  `
